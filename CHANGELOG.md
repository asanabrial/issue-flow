...
- Keep `operator.local.md` as an independently editable private file while bundles expose immutable
  ...
  validates journals and cleanup ownership without mutation. Legacy migration rejects reserved
  attachment names, linked policy and promisor/partial-clone authority before publishing state.
